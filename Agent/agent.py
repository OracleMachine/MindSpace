...
class MindSpaceAgent:
    ...
    async def engage_dialogue(self, user_message, channel_name, history: str = "", tools: list = None, mcp_sessions: list = None, on_progress=None):
        ...
        system_parts.append(
            ...
            "specifically belongs in an existing structured file (e.g., a research report, a "
            "faction model, or an article). This will generate a Git-style diff for the user's "
            "approval. This is the PREFERRED way to maintain high-quality structured knowledge.\n\n"
            "**CRITICAL RULES:**\n"
